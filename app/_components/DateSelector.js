...
function DateSelector(
  ...
  return (
    <div className="flex flex-col justify-between">
      <DayPicker
        className="pt-12 px-2 place-self-center"
        classNames={{
          today: `border border-accent-500`,
          selected: `bg-accent-500 fill-accent-500 text-black`,
        ...
        numberOfMonths={2}
        disabled={(curr) =>
          isPast(curr) || bookedDates.some(bookedDate => isSameDay(bookedDate, curr))
      }
      />
